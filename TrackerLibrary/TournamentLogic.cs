...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        private static void AlertPersonToNewRound(PersonModel p, string teamName, MatchupEntryModel competitor)
        {
            ...
            if(competitor != null)
            {
                subject = $"You have a new matchup witch { competitor.TeamCompeting.TeamName }";
        ...
        private static void CompleteTournament(TournamentModel model)
        {
            ...
            decimal winnerPrize = 0;//First place
            decimal runnerUpPrize = 0;//Second place
            ...
            body.Append("<p>Congrlatulations to our winner on a great tournament. </p>");
            body.Append("<br />");
